...
export class GameMode {
    ...
    configure() {
        GameRules.SetCustomGameTeamMaxPlayers(2 /* DotaTeam.GOODGUYS */, 3);
        GameRules.SetCustomGameTeamMaxPlayers(3 /* DotaTeam.BADGUYS */, 3);
    ...
    OnStateChange() {
        ...
        if (IsInToolsMode() && state == 2 /* GameState.CUSTOM_GAME_SETUP */) {
            for (let i = 0; i < 4; i++) {
                Tutorial.AddBot("npc_dota_hero_lina", "", "", false);
            }
        }
        if (state === 2 /* GameState.CUSTOM_GAME_SETUP */) {
